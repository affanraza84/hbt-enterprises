...
const AIR_CONDITIONERS: Product[] = [
  {
    ...
    slug: "voltas-1.5-split", category: "Air Conditioner", images: [], description: "", stock: 20, createdAt: new Date(), updatedAt: new Date(), rating: 4.5, reviewsCount: 300
  },
  {
    id: "ac-2", name: "LG 1.5 Ton 5 Star AI DUAL Inverter Split AC", price: 44490, originalPrice: 78990,
    slug: "lg-1.5-split-ai", category: "Air Conditioner", images: [], description: "", stock: 18, createdAt: new Date(), updatedAt: new Date(), rating: 4.7, reviewsCount: 410
  },
  {
    id: "ac-3", name: "Daikin 1.5 Ton 5 Star Inverter Split AC", price: 45490, originalPrice: 67200,
    slug: "daikin-1.5-split", category: "Air Conditioner", images: [], description: "", stock: 15, createdAt: new Date(), updatedAt: new Date(), rating: 4.8, reviewsCount: 350
  },
  {
    id: "ac-4", name: "Carrier 1.5 Ton 5 Star AI Flexicool Inverter Split AC", price: 41990, originalPrice: 76000,
    slug: "carrier-1.5-split", category: "Air Conditioner", images: [], description: "", stock: 12, createdAt: new Date(), updatedAt: new Date(), rating: 4.4, reviewsCount: 220
  },
  {
    id: "ac-5", name: "Blue Star 1.5 Ton 5 Star Inverter Split AC", price: 42990, originalPrice: 75000,
    slug: "blue-star-1.5-split", category: "Air Conditioner", images: [], description: "", stock: 10, createdAt: new Date(), updatedAt: new Date(), rating: 4.5, reviewsCount: 180
  },
  {
    id: "ac-6", name: "Panasonic 1.5 Ton 5 Star Wi-Fi Inverter Smart Split AC", price: 42990, originalPrice: 63400,
    slug: "panasonic-1.5-smart-split", category: "Air Conditioner", images: [], description: "", stock: 14, createdAt: new Date(), updatedAt: new Date(), rating: 4.6, reviewsCount: 290
  },
];
