  ...
  return (
    <div className="min-h-screen bg-neutral-light dark:bg-neutral-900 pb-24 pt-4">
      ...
      <div className="px-4 space-y-4">
        {CATEGORIES.map((cat) => (
          <div key={cat.id} className="bg-white dark:bg-neutral-800 rounded-2xl border border-neutral-200 dark:border-neutral-700 overflow-hidden shadow-sm">
                  ...
                  <div className="divide-y divide-neutral-100 dark:divide-neutral-700/50">
                    {group.items.map((item, i) => (
                      <Link 
                        ...
                        className="flex items-center justify-between px-4 py-3.5 text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-700/30 active:bg-neutral-100 transition-colors"
                      >
                        {item}
